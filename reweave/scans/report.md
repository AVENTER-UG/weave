...
c-ares                            1.33.1-r0                                            apk        CVE-2025-31498       High      0.1% (29th)    < 0.1  
...
curl                              8.12.1-r0                                            apk        CVE-2025-4947        Medium    < 0.1% (3rd)   < 0.1  
curl                              8.12.1-r0                                            apk        CVE-2025-5025        Medium    < 0.1% (3rd)   < 0.1  
busybox                           1.36.1-r30                                           apk        CVE-2024-58251       Low       < 0.1% (7th)   < 0.1  
busybox-binsh                     1.36.1-r30                                           apk        CVE-2024-58251       Low       < 0.1% (7th)   < 0.1  
ssl_client                        1.36.1-r30                                           apk        CVE-2024-58251       Low       < 0.1% (7th)   < 0.1  
golang.org/x/net                  v0.33.0               0.36.0                         go-module  GHSA-qxp5-gwg8-xv66  Medium    < 0.1% (2nd)   < 0.1  
busybox                           1.36.1-r30                                           apk        CVE-2025-46394       Low       < 0.1% (4th)   < 0.1  
busybox-binsh                     1.36.1-r30                                           apk        CVE-2025-46394       Low       < 0.1% (4th)   < 0.1  
ssl_client                        1.36.1-r30                                           apk        CVE-2025-46394       Low       < 0.1% (4th)   < 0.1  
